...
def visualize_prediction(mean_pred, var_pred, ground_truth, idx=0):
    ...
    fig.colorbar(im0, ax=axs[0], orientation='vertical')  # 添加颜色条
    ...
    fig.colorbar(im1, ax=axs[1], orientation='vertical')  # 添加颜色条
    ...
    fig.colorbar(im2, ax=axs[2], orientation='vertical')  # 添加颜色条
